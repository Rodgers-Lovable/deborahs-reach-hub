        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-6 pt-6 border-t border-border text-center">
            <p className="text-xs text-muted-foreground max-w-2xl mx-auto">
              All sessions are conducted in compliance with professional teaching standards and
              child safety protocols. Individual results may vary based on each child's unique
